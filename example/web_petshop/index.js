...
var NTI721420300 = {size: 0, kind: 24, base: null, node: null, finalizer: null};
NTI721420300.base = NTI33554439;
...
function getInventory_721420292() {
  var result_721420293 = ({species: []});

    result_721420293.species = nimCopy(null, [makeNimstrLit("Cat"), makeNimstrLit("Dog"), makeNimstrLit("Rabbit")], NTI721420300);

  return result_721420293;
...
function addChars_251658415(result_251658417, result_251658417_Idx, x_251658418, start_251658419, n_251658420) {
    ...
    Label1: do {
      ...
      Label2: do {
          Label3: while (true) {
          if (!(i_469762127 < n_251658420)) break Label3;
            iHEX60gensym4_251658435 = i_469762127;
            result_251658417[result_251658417_Idx][chckIndx(addInt(old_251658421, iHEX60gensym4_251658435), 0, (result_251658417[result_251658417_Idx]).length - 1)] = x_251658418.charCodeAt(chckIndx(addInt(start_251658419, iHEX60gensym4_251658435), 0, (x_251658418).length - 1));
            i_469762127 = addInt(i_469762127, 1);
          }
      } while (false);
    } while (false);
...
function getMOTD() {
    var motdH3_469762064 = document.getElementById("motd");
    motdH3_469762064.innerHTML = "Super sale today!";
    var petObj_469762065 = getInventory_721420292();
    var petListUL_469762066 = document.getElementById("inventory-list");
    Label1: do {
      var item_469762088 = null;
      var item_469762088_Idx = 0;
      var i_469762120 = 0;
      var L_469762121 = (petObj_469762065.species).length;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762120 < L_469762121)) break Label3;
            item_469762088 = petObj_469762065.species; item_469762088_Idx = chckIndx(i_469762120, 0, (petObj_469762065.species).length - 1);
            var pet_469762089 = document.createElement("li");
            var petName_469762090 = document.createTextNode(toJSStr(item_469762088[item_469762088_Idx]));
            pet_469762089.appendChild(petName_469762090);
            petListUL_469762066.appendChild(pet_469762089);
            i_469762120 = addInt(i_469762120, 1);
            if (!(((petObj_469762065.species).length == L_469762121))) {
